...
let md5Bfkc = "b14d1e9baeced9bb7525ab19ee35f2d2"; //Bfkc MD5 加密开启vconsole模式
let md5UnBfkc = "3dca2162c4e101b7656793a1af20295c"; //UN_CREMB MD5 加密关闭vconsole模式


if (vconsole !== undefined) {
  if (vconsole === md5UnBfkc && Cookies.has(cookieName))
    Cookies.remove(cookieName);
} else vconsole = Cookies.get(cookieName);

if (vconsole !== undefined && vconsole === md5Bfkc) {
  Cookies.set(cookieName, md5Bfkc, 3600);
...
__s.src=`${SettingMer.apiBaseURL}/public/jsconfig/getbfkcchatconfig`;
