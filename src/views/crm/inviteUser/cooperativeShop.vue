  ...
  <div class="divBox">
    ...
    >
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="合作商铺等级" prop="region">
          <el-select v-model="ruleForm.userLevelId" placeholder="请选择合作店铺等级">
            <el-option
              v-for="item in dealerLevelList"
              :key="item.id"
              :label="item.gradeName"
...
import {
  ...
  agentGradeList,
  changeDisGradeLevel,
  changeAgentGradeLevel,
  updateDeposit,
  getUserDistributor,
  changecooperateShopLevel
} from '@/api/crm/inviteUser.js'
        ...
        if (valid) {
          ...
          switch (index) {
            case '1':
              ...
              break;
            case '4':
              changecooperateShopLevel(this.ruleForm.ids, this.ruleForm.userLevelId).then(res => {
                if(res.code == 200) {
                  this.$message.success(res.msg);
                  this.ruleForm = {
                    ids: null,
