...
export function marketingListApi(params) {
  return request({
    url: '/api/admin/marketing/coupon/list',
    method: 'get',
    params
  })
}
...
export function couponSaveApi(data) {
  return request({
    url: '/api/admin/marketing/coupon/save',
    method: 'post',
    data
  })
}
...
export function couponIssueStatusApi(params) {
  return request({
    url: '/api/admin/marketing/coupon/update/status',
    method: 'post',
    params
  })
}
...
export function couponDeleteApi(params) {
  return request({
    url: '/api/admin/marketing/coupon/delete',
    method: 'post',
    params
  })
}
...
export function couponUserListApi(params) {
  return request({
    url: '/api/admin/marketing/coupon/user/list',
    method: 'get',
    params
  })
}
...
export function seckillInfoApi(params) {
  return request({
    url: '/api/admin/store/seckill/manger/info',
    method: 'get',
    params
  })
}
...
export function seckillUpdateApi(params, data) {
  return request({
    url: '/api/admin/store/seckill/manger/update',
    method: 'post',
    params,
    data
  })
...
export function seckillStoreInfoApi(params) {
  return request({
    url: '/api/admin/store/seckill/info',
    method: 'get',
    params
  })
}
...
export function seckillStoreSaveApi(data) {
  return request({
    url: '/api/admin/store/seckill/save',
    method: 'post',
    data
  })
}
...
export function seckillStoreUpdateApi(params, data) {
  return request({
    url: '/api/admin/store/seckill/update',
    method: 'post',
    params,
    data
  })
...
export function seckillStoreStatusApi(params) {
  return request({
    url: '/api/admin/store/seckill/update/status',
    method: 'post',
    params
  })
}
...
export function seckillConfigStatusApi(id,params) {
  return request({
    url: `/api/admin/store/seckill/manger/update/status/${id}`,
    method: 'post',
    params
  })
}
...
export function bargainSaveApi(data) {
  return request({
    url: `/api/admin/store/bargain/save`,
    method: 'POST',
    data
  })
}
...
export function bargainInfoApi(params) {
  return request({
    url: `/api/admin/store/bargain/info`,
    method: 'get',
    params
  })
}
...
export function bargainUpdateApi(params, data) {
  return request({
    url: `/api/admin/store/bargain/update`,
    method: 'post',
    params,
    data
  })
...
export function bargainStatusApi(params) {
  return request({
    url: `/api/admin/store/bargain/update/status`,
    method: 'post',
    params
  })
}
...
export function combinationSaveApi(data) {
  return request({
    url: `/api/admin/store/combination/save`,
    method: 'post',
    data
  })
}
...
export function combinationUpdateApi(params,data) {
  return request({
    url: `/api/admin/store/combination/update`,
    method: 'post',
    params,
    data
  })
...
export function combinationInfoApi(params) {
  return request({
    url: `/api/admin/store/combination/info`,
    method: 'get',
    params
  })
}
...
export function combinationStatusApi(params) {
  return request({
    url: `/api/admin/store/combination/update/status`,
    method: 'post',
    params
  })
}
...
export function exportBargainApi(params) {
  return request({
    url: `/api/admin/export/excel/bargain/product`,
    method: 'get',
    params
  })
}
...
export function exportcombiantionApi(params) {
  return request({
    url: `/api/admin/export/excel/combiantion/product`,
    method: 'get',
    params
  })
}
...
export function draftListApi(params) {
  return request({
    url: `/api/admin/pay/component/product/draft/list`,
    method: 'get',
    params
  })
}
...
export function videoProductListApi(params) {
  return request({
    url: `/api/admin/pay/component/product/list`,
    method: 'get',
    params
  })
}
...
export function catListApi(params) {
  return request({
    url: `/api/admin/pay/component/cat/get/list`,
    method: 'get'
  })
}
...
export function videoAddApi(data) {
  return request({
    url: `/api/admin/pay/component/product/add`,
    method: 'post',
    data
  })
}
...
export function videoUpdateApi(data) {
  return request({
    url: `/api/admin/pay/component/product/update`,
    method: 'post',
    data
  })
}
...
export function videoUpApi(proId) {
  return request({
    url: `/api/admin/pay/component/product/listing/${proId}`,
    method: 'post'
  })
}
...
export function videoDownApi(proId) {
  return request({
    url: `/api/admin/pay/component/product/delisting/${proId}`,
    method: 'post'
  })
}
...
export function videoDelApi(proId) {
  return request({
    url: `/api/admin/pay/component/product/delete/${proId}`,
    method: 'post'
  })
}
...
export function draftInfoApi(id) {
  return request({
    url: `/api/admin/pay/component/product/draft/get/${id}`,
    method: 'get'
  })
}
