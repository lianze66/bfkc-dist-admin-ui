...
export function configApi() {
  return request({
    url: '/api/admin/store/retail/spread/manage/get',
    method: 'get'
  })
}
...
export function configUpdateApi(data) {
  return request({
    url: '/api/admin/store/retail/spread/manage/set',
    method: 'post',
    data
  })
}
...
export function promoterListApi(params) {
  return request({
    url: '/api/admin/store/retail/list',
    method: 'get',
    params
  })
}
...
export function spreadListApi( params, data) {
  return request({
    url: '/api/admin/store/retail/spread/userlist',
    method: 'post',
    params,
    data
  })
...
export function spreadOrderListApi(params, data) {
  return request({
    url: '/api/admin/store/retail/spread/orderlist',
    method: 'post',
    params,
    data
  })
...
export function spreadStatisticsApi(params) {
  return request({
    url: `/api/admin/store/retail/statistics`,
    method: 'get',
    params
  })
}
