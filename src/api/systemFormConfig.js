...
export function notificationListApi(pram) {
  ...
  return request({
    url: '/api/admin/system/notification/list',
    method: 'GET',
    params: data
  })
}
 ...
 */
 export function notificationRoutine(id) {
  return request({
    url: `/api/admin/system/notification/routine/switch/${id}`,
    method: 'post',
  })
}
 ...
 */
 export function notificationWechat(id) {
  return request({
    url: `/api/admin/system/notification/wechat/switch/${id}`,
    method: 'post',
  })
}
 ...
 */
 export function notificationSms(id) {
  return request({
    url: `/api/admin/system/notification/sms/switch/${id}`,
    method: 'post',
  })
}
 ...
 */
 export function notificationDetail(param) {
  ...
  return request({
    url: `/api/admin/system/notification/detail`,
    method: 'get',
    params:data
  })
}

//api/admin/system/notification/detail
/**
 * 修改通知
 * @param pram
 */
 ...
 return request({
   url: `/api/admin/system/notification/update`,
   method: 'post',
   data
 })
}