...
export function getMenu() {
  return request({
    url: '/api/admin/system/role/testMenu',
    method: 'GET'
  })
}
...
export function adminInfo(pram) {
  ...
  return request({
    url: '/api/admin/system/admin/info',
    method: 'GET',
    params: data
  })
}
...
export function updateIsSmsApi(params) {
  return request({
    url: `/api/admin/system/admin/update/isSms`,
    method: 'get',
    params
  })
}
 ...
 */
 export function menuListApi(params) {
  ...
  return request({
    url: `/api/admin/system/menu/list`,
    method: 'get',
    params:data
  })
}
 ...
 */
 export function menuDelete(id) {
  return request({
    url: `/api/admin/system/menu/delete/${id}`,
    method: 'post',
  })
}
 ...
 */
 export function menuInfo(id) {
  return request({
    url: `/api/admin/system/menu/info/${id}`,
    method: 'get',
  })
}
 ...
 */
 export function menuUpdateShowStatus(params) {
  return request({
    url: `/api/admin/system/menu/updateShowStatus`,
    method: 'post',
    params
  })
}
 ...
 */
 export function sensitiveListApi(params) {
  return request({
    url: `/api/admin/log/sensitive/list`,
    method: 'get',
    params
  })
}