...
export function cityList(data) {
  return request({
    url: '/api/admin/system/city/list',
    method: 'get',
    params: { ...data }
  })
}
...
export function updateStatus(data) {
  return request({
    url: '/api/admin/system/city/update/status',
    method: 'post',
    params: { ...data }
  })
}
...
export function cityUpdate(data) {
  return request({
    url: '/api/admin/system/city/update',
    method: 'post',
    params: { ...data }
  })
}
...
export function cityInfo(data) {
  return request({
    url: '/api/admin/system/city/info',
    method: 'get',
    params: { ...data }
  })
}
...
export function expressSyncApi() {
  return request({
    url: '/api/admin/express/sync/express',
    method: 'post'
  })
}
...
export function expressUpdateShow(data) {
  return request({
    url: '/api/admin/express/update/show',
    method: 'post',
    data
  })
}
