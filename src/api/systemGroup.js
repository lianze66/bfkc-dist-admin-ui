...
export function groupInfo(pram) {
  ...
  return request({
    url: '/api/admin/system/group/info',
    method: 'GET',
    params: data
  })
}
...
export function designListApi() {
  return request.get(`/api/admin/page/layout/index`)
}
 ...
 */
 export function getDataApi(data) {
  return request({
    url: '/api/admin/page/layout/category/config',
    method: 'GET',
    data
  })
}
 ...
 */
 export function themeSave(params) {
  return request({
    url: `/api/admin/system/config/saveuniq`,
    method: 'post',
    params
  })
}
 ...
 */
 export function getTheme(params) {
  return request({
    url: `/api/admin/system/config/getuniq`,
    method: 'get',
    params
  })
}
