 ...
 */
 export function levelUpdateApi(params, data) {
  return request({
    url: `/api/admin/system/user/level/update/${params}`,
    method: 'post',
    // params,
    data
  })
...
export function levelInfoApi(params) {
  return request({
    url: `/api/admin/system/user/level/info`,
    method: 'get',
    params
  })
}
...
export function updatePhoneApi(params) {
  return request({
    url: `/api/admin/user/update/phone`,
    method: 'get',
    params
  })
}
