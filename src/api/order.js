...
export function orderListDataApi(params) {
  return request({
    url: '/api/admin/store/order/list/data',
    method: 'get',
    params
  })
}
...
export function orderDeleteApi(params) {
  return request({
    url: '/api/admin/store/order/delete',
    method: 'get',
    params
  })
}
...
export function orderUpdateApi(data, params) {
  return request({
    url: '/api/admin/store/order/update',
    method: 'post',
    data,
    params
  })
...
export function orderLogApi(params) {
  return request({
    url: '/api/admin/store/order/status/list',
    method: 'get',
    params
  })
}
...
export function orderMarkApi(params) {
  return request({
    url: '/api/admin/store/order/mark',
    method: 'post',
    params
  })
}
...
export function orderSendApi(data) {
  return request({
    url: '/api/admin/store/order/send',
    method: 'post',
    data
  })
}
...
export function orderRefuseApi(params) {
  return request({
    url: '/api/admin/store/order/refund/refuse',
    method: 'get',
    params
  })
}
...
export function orderRefundApi(params) {
  return request({
    url: '/api/admin/store/order/refund',
    method: 'get',
    params
  })
}
...
export function writeUpdateApi(vCode) {
  return request({
    url: `/api/admin/store/order/writeUpdate/${vCode}`,
    method: 'get'
  })
}
...
export function writeConfirmApi(vCode) {
  return request({
    url: `/api/admin/store/order/writeConfirm/${vCode}`,
    method: 'get'
  })
}
...
export function orderStatisticsApi() {
  return request({
    url: `/api/admin/store/order/statistics`,
    method: 'get'
  })
}
...
export function statisticsDataApi(params) {
  return request({
    url: `/api/admin/store/order/statisticsData`,
    method: 'get',
    params
  })
}
...
export function orderTimeApi(params) {
  return request({
    url: `/api/admin/store/order/time`,
    method: 'get',
    params
  })
}
...
export function sheetInfoApi() {
  return request({
    url: `/api/admin/store/order/sheet/info`,
    method: 'get'
  })
}
...
export function getLogisticsInfoApi(params) {
  return request({
    url: `/api/admin/store/order/getLogisticsInfo`,
    method: 'get',
    params
  })
}
...
export function companyGetListApi() {
  return request({
    url: `/api/admin/pay/component/delivery/company/get/list`,
    method: 'get'
  })
}
...
export function videoSendApi(data) {
  return request({
    url: `/api/admin/store/order/video/send`,
    method: 'post',
    data
  })
}
