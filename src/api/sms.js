...
export function smsLstApi(params) {
  return request({
    url: '/api/admin/pass/user/record',
    method: 'get',
    params
  })
}
...
export function captchaApi(params) {
  return request({
    url: `/api/admin/pass/sendUserCode`,
    method: 'get',
    params
  })
}
...
export function updatePasswordApi(data) {
  return request({
    url: '/api/admin/pass/update/password',
    method: 'post',
    data
  })
}
...
export function updateHoneApi(data) {
  return request({
    url: '/api/admin/pass/update/phone',
    method: 'post',
    data
  })
}
...
export function serviceOpenApi(data) {
  return request({
    url: '/api/admin/pass/service/open',
    method: 'post',
    data
  })
}
...
export function exportTempApi(params) {
  return request({
    url: '/api/admin/express/template',
    method: 'get',
    params
  })
}
