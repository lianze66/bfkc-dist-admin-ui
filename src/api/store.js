...
export function productUpdateApi(data) {
  return request({
    url: '/api/admin/store/product/update',
    method: 'POST',
    data
  })
}
...
export function templateListApi(params) {
  return request({
    url: '/api/admin/store/product/rule/list',
    method: 'GET',
    params
  })
}
...
export function replyListApi(params) {
  return request({
    url: '/api/admin/store/product/reply/list',
    method: 'GET',
    params
  })
}
...
export function replyCreatApi(data) {
  return request({
    url: '/api/admin/store/product/reply/save',
    method: 'POST',
    data
  })
}
...
export function replyEditApi(data) {
  return request({
    url: '/api/admin/store/product/reply/update',
    method: 'POST',
    data
  })
}
...
export function replyDeleteApi(id) {
  return request({
    url: `/api/admin/store/product/reply/delete/${id}`,
    method: 'GET'
  })
}
...
export function replyCommentApi(data) {
  return request({
    url: `/api/admin/store/product/reply/comment`,
    method: 'post',
    data
  })
}
...
export function productExportApi(params) {
  return request({
    url: `/api/admin/export/excel/product`,
    method: 'get',
    params
  })
}
...
export function importProductApi(params) {
  return request({
    url: `/api/admin/store/product/importProduct`,
    method: 'post',
    params
  })
}
...
export function copyProductApi(data) {
  return request({
    url: `/api/admin/store/product/copy/product`,
    method: 'post',
    data
  })
}
...
export function copyConfigApi() {
  return request({
    url: `/api/admin/store/product/copy/config`,
    method: 'post'
  })
}
 ...
 */
 export function orderExcelApi(params) {
  return request({
    url: `/api/admin/export/excel/order`,
    method: 'get',
    params
  })
}